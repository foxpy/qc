...
int main(void) {
    check_u64_to_be(((uint8_t[8]){0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF}),
                    UINT64_C(0x0123456789ABCDEF));
    check_u64_to_be(((uint8_t[8]){0xFE, 0xDC, 0xBA, 0x98, 0x76, 0x54, 0x32, 0x10}),
                    UINT64_C(0xFEDCBA9876543210));
    check_u64_to_le(((uint8_t[8]){0xEF, 0xCD, 0xAB, 0x89, 0x67, 0x45, 0x23, 0x01}),
                    UINT64_C(0x0123456789ABCDEF));
    check_u64_to_le(((uint8_t[8]){0x10, 0x32, 0x54, 0x76, 0x98, 0xBA, 0xDC, 0xFE}),
                    UINT64_C(0xFEDCBA9876543210));
    check_u64_to_be(((uint8_t[8]){0x67, 0x58, 0x26, 0x47, 0xCE, 0xB3, 0xFE, 0x00}),
                    UINT64_C(0x67582647CEB3FE00));
    check_u64_to_le(((uint8_t[8]){0x00, 0xFE, 0xB3, 0xCE, 0x47, 0x26, 0x58, 0x67}),
                    UINT64_C(0x67582647CEB3FE00));
    check_u64_to_be(((uint8_t[8]){0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xF1, 0xB3, 0x18}),
                    UINT64_C(0xFFFFFFFFFFF1B318));
    check_u64_to_le(((uint8_t[8]){0x18, 0xB3, 0xF1, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}),
                    UINT64_C(0xFFFFFFFFFFF1B318));
